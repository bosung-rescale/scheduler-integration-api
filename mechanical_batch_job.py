...
if __name__ == '__main__':
    ...
    parser.add_argument('--ver', '-v', required=False, default='2020r1', help='Mechanical Version, \
                         16.2 / 17.0 / 17.1 / 17.2 / 18.0 / 18.1 / 18.2 / 19.0 / 19.1 / 19.2 / 2019r1 / 2019r2 / 2019r3 / 2020r1 / 2020r2 / 2021r1/ 2021r2')
    parser.add_argument('--option', '-o', required=False, default='', help='Mechanical Option')
...
# Analysis version check
    code_name = 'ansys_mechanical'  # Ansys Mechanical
...
# job_command set
    #command = 'mechanical 3ddp -gu -ssh -cnf=$HOME/mpd.hosts -t'+ str(num_of_cores) + ' -i ' + journal_file +' -driver x11 \n'
    command = 'export LICENSE_FEATURE=meba \n' \
             +'ansys${ANSYSMECH_VERSION/./} -dis -b -np ' + str(num_of_cores) + ' -machines $MACHINES -i ' + os.path.basename(input_files[0]) + ' -p $LICENSE_FEATURE \n'
...
# Monitoring Job
    ...
    # Mechanical tail out file name
    mechanical_tail_out = 'process_output.log'
        ...
        if (current_status != prev_status) :
            ...
            while current_status == 'Executing' :
                if cluster_started == False :
                    pub_hostname = cluster_info(job_name)
                    cluster_started = True

                # Live tail of Mechanical tail out
                tail_file_url = rescale_platform + '/api/v2/jobs/' + job_id + '/runs/1/tail/' + mechanical_tail_out
