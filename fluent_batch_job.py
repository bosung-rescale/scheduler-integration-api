...
# Analysis version check
    code_name = 'ansys_fluent'  # Ansys Fluent
...
# job_command set
#    command = 'fluent 3ddp -gu -ssh -cnf=$HOME/mpd.hosts -t'+ str(core_per_slot) + ' -i ' + journal_file +' -driver x11 \n'
    command = 'fluent 3ddp -gu -ssh -cnf=$HOME/mpd.hosts -t'+ str(num_of_cores) + ' -i ' + os.path.basename(journal_file) +' -driver x11 \n'
...
# Monitoring Job
    ...
    # Fluent tail out file name
    fluent_tail_out = 'process_output.log'
    ...
    while job_completed == False :
        ...
        if (current_status != prev_status) :
            ...
            while current_status == 'Executing' :
                ...
                # Live tail of Fluent tail out
                tail_file_url = rescale_platform + '/api/v2/jobs/' + job_id + '/runs/1/tail/' + fluent_tail_out
